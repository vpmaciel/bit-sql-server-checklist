...
public class SobrePainelCad extends JPanel {
	...
	private void inicializarGui() {
		...
		labelTitulo.setText("CLOUDDB - SQL SERVER MONITOR 1.0");
		...
		labelEmpresa.setText("<html><a href=\"https://www.clouddb.com.br/\">https://www.clouddb.com.br/</a><html>");
		...
		// this.add(labelAutor, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
